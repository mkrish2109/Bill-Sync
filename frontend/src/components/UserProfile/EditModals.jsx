...
export const EditProfileModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-[700px]">
      <div className=" w-full overflow-y-auto rounded-3xl p-4  lg:p-8">
        <div className="px-2 pr-8 sm:pr-14">
          ...
          <p className="mb-4 sm:mb-6 text-sm text-secondary-light dark:text-text-secondaryDark lg:mb-7">
            Update your details to keep your profile up-to-date.
          </p>
        </div>
        <form className="flex flex-col">
          <div className="h-[400px] sm:h-[450px] overflow-y-auto px-2 pb-3 scrollbar-thin scrollbar-thumb-primary-light dark:scrollbar-thumb-primary-dark scrollbar-track-background-surfaceLight dark:scrollbar-track-background-surfaceDark">
                ...
                {personalInfo.map((info, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      {errors[info.name] && (
                        <span className="text-error-base text-xs mt-1 block">
                          {errors[info.name]}
                        </span>
                      )}
                      {info.name === "bio" && (
                        <p className="text-xs text-secondary-light dark:text-text-secondaryDark mt-1">
...
export const EditAddressModal = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-[700px]">
      <div className=" w-full overflow-y-auto rounded-3xl  lg:p-8">
        <div className="px-2 pr-8 sm:pr-14">
          <h4 className="mb-2 text-xl sm:text-2xl font-semibold text-text-light dark:text-text-dark/90">
              ...
              <div className="grid grid-cols-1 gap-x-4 sm:gap-x-6 gap-y-4 sm:gap-y-5 lg:grid-cols-2">
                {addressInfo.map((info, index) => (
                  <div
                    key={index}
                    className={
                      info.label.includes("Address Line")
                        ? "col-span-2"
                        : "col-span-2 lg:col-span-1"
                    }
                  >
                    <Label htmlFor={info.name} className="text-sm sm:text-base">
                      {info.label}
                    </Label>
                    <TextInput
                      id={info.name}
            ...
            <div className="mt-4 sm:mt-7">
                  ...
                  <img
                    src={
                      formData.image[0]
                        ...
                        : user?.image?.[0] || "/images/profile.webp"
                    }
                    alt="Preview"
              ...
              <div className="grid grid-cols-1 gap-x-4 sm:gap-x-6 gap-y-4 sm:gap-y-5 lg:grid-cols-2">
                <div className="col-span-2 lg:col-span-1">
                  <Label htmlFor="fname" className="text-sm sm:text-base">
                    First Name
                  </Label>
                  <TextInput
                    id="fname"
                ...
                <div className="col-span-2 lg:col-span-1">
                  <Label htmlFor="lname" className="text-sm sm:text-base">
                    Last Name
                  </Label>
                  <TextInput
                    id="lname"
