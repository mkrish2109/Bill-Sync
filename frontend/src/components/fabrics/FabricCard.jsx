...
export const FabricCard = ({
  ...
  console.log(fabric.assignmentStatus);
  return (
    <>
                  ...
                  {onStatusChange ? (
                    <div className="relative">
                      <select
                        ...
                        ${colors.text}
                        ${colors.border}
                         || 'bg-secondary-light/20 text-secondary-light dark:bg-secondary-dark/20 dark:text-secondary-dark'} focus:outline-none focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark focus:border-transparent ${
                          isUpdatingStatus
