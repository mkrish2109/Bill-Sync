    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm hover:shadow-md transition-shadow duration-200">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-secondary-light dark:text-secondary-dark font-medium">Created At:</span>
            <span className="text-text-light dark:text-text-dark">{new Date(fabric.createdAt).toLocaleString()}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-secondary-light dark:text-secondary-dark font-medium">Updated At:</span>
      ...
      {fabric.notes && (
        <div className="bg-surface-light dark:bg-surface-dark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <p className="text-secondary-light dark:text-secondary-dark leading-relaxed">{fabric.notes}</p>
        </div>
      )}
    </div>
  </div>
