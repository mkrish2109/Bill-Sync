    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div className="bg-background-surfaceLight dark:bg-background-surfaceDark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm hover:shadow-md transition-shadow duration-200">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-secondary-light dark:text-text-secondaryDark font-medium">
              Created At:
            </span>
      ...
      {fabric.notes && (
        <div className="bg-background-surfaceLight dark:bg-background-surfaceDark p-6 rounded-xl border border-border-light dark:border-border-dark shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <p className="text-secondary-light dark:text-text-secondaryDark leading-relaxed">
            {fabric.notes}
          </p>
        </div>
      )}
