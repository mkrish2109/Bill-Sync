            ...
            >
                ...
                {viewType === "buyer" ? (
                  <>
                    ...
                    <div className="text-center">
                      <p className="text-sm text-secondary-light dark:text-text-secondaryDark">Quantity</p>
                      <p className="text-text-light dark:text-text-dark">
                        {fabric.quantity} {fabric.unit}
                      </p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm text-secondary-light dark:text-text-secondaryDark">Unit Price</p>
                      <p className="text-text-light dark:text-text-dark">
                        ${fabric.unitPrice?.toFixed(2) || '0.00'}
                      </p>
                    </div>
                    <div className="text-center">
                      <p className="text-sm text-secondary-light dark:text-text-secondaryDark">Total</p>
              ...
              <div className="p-4 grid gap-4 md:grid-cols-2 lg:grid-cols-2">
                {viewType === "buyer" ? (
                  <>
                    <div>
                      <h3 className="text-sm font-medium text-secondary-light dark:text-text-secondaryDark mb-2">
                        Assigned Worker(s)
                      </h3>
                      {fabric.workers?.length > 0 ? (
                        <div className="space-y-3">
                          {fabric.workers.map((worker, index) => (
                            <div
                              key={index}
                              className="bg-background-surfaceLight dark:bg-background-surfaceDark p-3 rounded-md"
                            >
                        ...
                        {onStatusChange ? (
                          <select
                            ...
                            className={`w-full p-3 text-sm rounded-md border border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark ${
                              ...
                              "bg-secondary-light/20 text-secondary-light dark:bg-secondary-dark/20 dark:text-text-secondaryDark"
                            } focus:outline-none focus:ring-1 focus:ring-primary-light dark:focus:ring-primary-dark focus:border-transparent`}
                          >
                            <option value="assigned">Assigned</option>
                            <option value="in-progress">In Progress</option>
                            <option value="completed">Completed</option>
