...
const FeatureCard = ({ icon, title, description, color }) => {
  ...
  return (
    ...
    >
      <Card 
        className="h-full hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700"
      >
        <div className={`text-${color}-500 dark:text-${color}-400 text-5xl mb-4`}>
          {icon}
        </div>
  ...
  return (
    ...
    >
      <div className="bg-blue-100 dark:bg-blue-900 rounded-full p-3 mr-4 flex-shrink-0">
        <span className="text-blue-600 dark:text-blue-300 font-bold text-xl">{number}</span>
      </div>
      <div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-600 dark:text-gray-300">
              Join thousands of professionals who trust Tex Bill for their billing needs.
            </p>
